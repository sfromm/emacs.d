...
#+BEGIN_SRC emacs-lisp
  (defun sf/mu4e-forward-as-attachment ()
    ...
    (interactive)
    (let ((subject (mu4e-message-field (mu4e-message-at-point t) :subject))
           (msgid (mu4e-message-field (mu4e-message-at-point t) :message-id))
           (docid (mu4e-message-field (mu4e-message-at-point t) :docid))
