...
(def-doom-theme doom-filbert-light
  ...
  ((bg         '("#fefcef" "#ffffaf" "brightwhite"  ))
   ...
   (base0      '("#f9f1d4" "#ffff87" "white"        ))
   (base1      '("#ebdbb2" "#ffdfaf" "white"        ))
   (base2      '("#d5c4a1" "#bcbcbc" "brightblack"  ))
   (base3      '("#bdae93" "#a8a8a8" "brightblack"  ))
   (base4      '("#a89984" "#949494" "brightblack"  ))
   (base5      '("#928374" "#8a8a8a" "brightblack"  ))
   (base6      '("#7c6f64" "#767676" "brightblack"  ))
   (base7      '("#665c54" "#626262" "brightblack"  ))
   (base8      '("#504945" "#4e4e4e" "brightblack"  ))
   (base9      '("#3c3836" "#3a3a3a" "black"        ))
   ...
   (teal       '("#427b58" "#5f8787" "brightgreen"  ))
   (blue       '("#076678" "#005f87" "brightblue"   ))
   (magenta    '("#D3879B" "#d787af" "brightmagenta"))
   (violet     '("#8f3f71" "#875f87" "magenta"      ))
   (cyan       '("#00a7af" "#00afaf" "brightcyan"   ))
   ...
   ;; --- Modeline config -------------------
   (modeline-fg     nil)
   (modeline-fg-alt (doom-blend blue base4 (if -modeline-bright 0.5 0.2)))
