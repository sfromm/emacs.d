...
(def-doom-theme doom-filbert-light
  ...
  ((bg         '("#fefcef" "#ffffaf" "brightwhite"  ))
   ...
   (base0      '("#ffffc8" "#ffffdf" "white"        ))
   (base1      '("#fdf4c1" "#ffffaf" "white"  ))
   (base2      '("#f4e8ba" "#ffff87" "brightblack"  ))
   (base3      '("#ebdbb2" "#ffdfaf" "brightblack"  ))
   (base4      '("#d5c4a1" "#bcbcbc" "brightblack"  ))
   (base5      '("#bdae93" "#a8a8a8" "brightblack"  ))
   (base6      '("#a89984" "#949494" "brightblack"  ))
   (base7      '("#7c6f64" "#767676" "brightblack"  ))
   (base8      '("#665c54" "#626262" "black"        ))
