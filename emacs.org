...
- HTML version :: https://github.com/sfromm/emacs.d/emacs.html
...
is.  For those providers where I can use IMAP, I use [[http://isync.sourceforge.net/][mbsync]] to sync mail to my
workstation.  I also use [[https://github.com/gauteh/lieer][lieer]] to pull and push email & labels from a Gmail
account.  I recommend reviewing the [[https://github.com/gauteh/lieer/blob/master/docs/index.md][instructions]] for more on how to setup and
configure /lieer/.
