...
#+begin_src emacs-lisp :tangle lisp/init-elpa.el :noweb yes
...
** Quelpa
Use Quelpa to install packages from source repositories.  This is no longer used
because of the ~package-vc-install~ functionality.
...
This package appears to be archived on github and no longer maintained.
...
#+begin_src emacs-lisp :tangle lisp/init-core.el :noweb yes
...
#+begin_src emacs-lisp :tangle lisp/init-core.el
(defgroup forge nil
...
window.  This probably could be simplified by using something like [[https://github.com/tumashu/posframe][posframe]].  I
haven't used this for a long time and, for now, is not tangled.
...
#+begin_src emacs-lisp :tangle lisp/init-appearance.el :noweb yes
...
#+begin_src emacs-lisp :tangle lisp/init-appearance.el

...
#+begin_src emacs-lisp :tangle lisp/init-ui-completion.el :noweb yes
...
#+begin_src emacs-lisp :tangle lisp/init-ui-completion.el

...
** Navigation
#+begin_src emacs-lisp :tangle lisp/init-navigation.el :noweb yes
...
#+begin_src emacs-lisp :tangle lisp/init-navigation.el
;;; windmove
...
Lastly, display line numbers any time in a programming-related buffer.
...
Update on [2023-02-05 Sun]: Stop tangling the twitter config.
...
#+begin_src emacs-lisp :tangle lisp/init-utils.el :noweb yes
...
init.el.  Not an actual emacs package.  Not used very much anymore, but left in place.
