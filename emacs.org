    ...
    (progn
      ...
      (setq
        ...
        mu4e-bookmarks '(
                          ...
                          ("date:3d..now" "Last 3 days" ?3)
                          ("date:7d..now" "Last 7 days" ?7)
                          ("flag:flagged" "Flagged" ?f)
                          ("maildir:/Personal/* AND NOT maildir:/Personal/Sent AND NOT maildir:/Personal/Trash" "Personal" ?p)
                          ("maildir:/Work/* AND NOT maildir:/Work/Sent AND NOT maildir:/Work/Trash" "Work" ?w)
                          ("maildir:/Work/Archive* OR maildir:/Personal/Archive" "Archive" ?a)
