  ...
  (use-package mu4e
    ...
    (progn
      ...
      (setq
        ...
        mu4e-refile-folder 'sf-custom/mu4e-refile-folder
...
#+BEGIN_SRC emacs-lisp
  (defun sf/mu4e-forward-abuse-message ()
    "Forward an abuse report to responsible party"
    (interactive)
...
#+BEGIN_SRC emacs-lisp
  (defun sf/mu4e-forward-infringement-message ()
...
#+BEGIN_SRC emacs-lisp
  ...
  _I_ Forward Infringement
  "
    ("f" sf/mu4e-forward-as-attachment)
    ("A" sf/mu4e-forward-abuse-message)
    ("I" sf/mu4e-forward-infringement-message)
